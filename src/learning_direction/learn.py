...
CLF_NAME = "forest_recurent_defaultparams"

dataset = np.load("dataset_recurent_same_nb.npy")
labels = np.load("labels_recurent_same_nb.npy")
print(dataset[1].sum)
print("***")
print("Result for classifier: %s" % CLF_NAME)
if DEBUG:
...
_ = joblib.dump(clf, CLF_FOLDER + CLF_NAME + "_recurent" +".joblib.pkl")
