...
This file contains the code used to generate the data while driving.
Each seconds we capture the current commands of the driver through
the xbox controller (speed, angle) and the current image to create
